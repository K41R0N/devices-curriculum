---
title: Teoría Mimética
slug: mimetic-theory
cluster: comparative-genesis
author: René Girard
order: 3
description: Cómo el deseo mimético impulsa el conflicto humano y la creación de la cultura.
objectives:
...
- Conectar la teoría mimética con el marco DEVICES comprendiendo cómo el deseo mimético
...
assignment:
  instructions: 'Lee la introducción a "Things Hidden Since the Foundation of the World"
    ...
    Girard el deseo mimético? ¿Cuál es la relación entre el deseo mimético y la violencia?
    ¿Cómo funciona el mecanismo del chivo expiatorio para crear orden social?

    '
  url: "https://archive.org/details/thingshiddensinc0000gira"
  reading_title: Things Hidden Since the Foundation of the World
knowledge_check:
- question: ¿Por qué el deseo es "triangular" según Girard?
  hint: Piensa en el papel del "otro" en la configuración de lo que queremos.
- question: ¿Cuál es la función social del chivo expiatorio?
  hint: ¿Cómo resuelve el chivo expiatorio la crisis de la rivalidad mimética?
- question: ¿Cómo conecta Girard la violencia con lo sagrado?
  hint: Considera la transformación de la víctima después de su muerte.
additional_resources:
- title: Deceit, Desire, and the Novel
  author: René Girard
  description: Primer trabajo importante de Girard, donde desarrolla la teoría del
    deseo mimético a través de un análisis de la novela moderna.
- title: Violence and the Sacred
  author: René Girard
  description: Un trabajo más antropológico donde Girard explora el papel del mecanismo
    del chivo expiatorio en la religión y los rituales arcaicos.
---
