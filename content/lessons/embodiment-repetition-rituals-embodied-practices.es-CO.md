---
title: Rituales y Prácticas Culturales Encarnadas
slug: rituals-and-embodied-cultural-practices
cluster: embodiment-repetition
author: Ohaja et al.
order: 3
description: Cómo los rituales funcionan como prácticas culturales encarnadas que dan forma a la identidad desde el inicio de la vida.
objectives:
...
knowledge_check:
  - question: ¿Cómo definen los autores la "encarnación" en el contexto del embarazo y la práctica cultural?
    hint: Busca su discusión del concepto de "hacer embarazo" de Neiterman en la introducción.
  - question: ¿Cuál es el significado cultural de los rituales de placenta en los contextos africanos descritos en el artículo?
    hint: Piensa en cómo se ve la placenta en relación con el niño, la comunidad y el mundo espiritual. A menudo se ve como más que solo material biológico.
  - question: ¿De qué manera funcionan las canciones de nacimiento y el baile (Egwu ọṅụ nwa) como un dispositivo cultural?
    hint: Considera los aspectos comunitarios, celebratorios y narrativos de estas prácticas. ¿Cómo refuerzan los lazos sociales y los valores culturales?
additional_resources:
  - title: "The Ritual Process: Structure and Anti-Structure"
    author: Victor Turner
    description: Un texto fundacional en los estudios rituales que introduce conceptos como 'liminality' y 'communitas', que proporcionan un marco teórico para entender el poder transformador de los ritos de paso.
  - title: The Body in Culture, Technology and Society
    author: Chris Shilling
    description: Explora la importancia sociológica del cuerpo y la encarnación, proporcionando un contexto más amplio para entender cómo nuestros seres físicos son moldeados por e interactúan con el mundo social.
---
